    ...
    if (request.querystring) {
        ...
        allowedHeaders.forEach(header => {
            if (request.querystring[header]) {
                if (header.toLowerCase() === 'x-amz-date') {
                    request.headers['x-amz-date-temp'] = {value: String(request.querystring[header].value)};
                }
                request.headers[header.toLowerCase()] = {value: String(request.querystring[header].value)};
            }
        });
